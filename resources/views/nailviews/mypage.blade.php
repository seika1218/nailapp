...
<body>
    <main>
        ...
        <form method="post" action="/mypageeditcomplete/{{$value->id}}" name="form">
        @csrf     
        <div class="stuff">
        ...
        <form method="get" action="/userdelete" class="deleteform">

      <button type="submit" class="login-button">退会
      </button>
    </form>
